...
/**
* @class BillboardScript
* @brief ビルボードを行うスクリプトクラス
*/
class BillboardScript
...
public:
    ...
    */
    BillboardScript(const std::shared_ptr<GameObject>& owner, const std::string& name, bool _enableSerialize)
