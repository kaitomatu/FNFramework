...
namespace KDFramework
{
    ...
    {
        // 全ノードデータ
        std::vector<KDFramework::KdGLTFNode> Nodes;
        ...
        // マテリアル一覧
        std::vector<KDFramework::KdGLTFMaterial> Materials;

        // アニメーションデータリスト
        std::vector<std::shared_ptr<KDFramework::KdGLTFAnimationData>> Animations;
    };
    ...
    // ・path				… .glflファイルのパス
    //===================================================
    std::shared_ptr<KDFramework::KdGLTFModel> KdLoadGLTFModel(std::string_view path);
}
