...
///// ///// ///// ///// ///// ///// ///// ///// ///// ///// ///// ///// ///// ///// /////
void KdCollider::RegisterCollisionShape(std::string_view name, const std::shared_ptr<ModelData>& model, UINT type)
{
    RegisterCollisionShape(name, std::make_unique<KdModelCollision>(model, type));
}

///// ///// ///// ///// ///// ///// ///// ///// ///// ///// ///// ///// ///// ///// /////
void KdCollider::RegisterCollisionShape(std::string_view name, ModelData* model, UINT type)
{
    RegisterCollisionShape(name, std::make_unique<KdModelCollision>(std::shared_ptr<ModelData>(model), type));
}

///// ///// ///// ///// ///// ///// ///// ///// ///// ///// ///// ///// ///// ///// /////
void KdCollider::RegisterCollisionShape(std::string_view name, const std::shared_ptr<class Polygon> polygon, UINT type)
{
    RegisterCollisionShape(name, std::make_unique<KdPolygonCollision>(polygon, type));
}

///// ///// ///// ///// ///// ///// ///// ///// ///// ///// ///// ///// ///// ///// /////
void KdCollider::RegisterCollisionShape(std::string_view name, class Polygon* polygon, UINT type)
{
    RegisterCollisionShape(name, std::make_unique<KdPolygonCollision>(std::shared_ptr<class Polygon>(polygon), type));
}
...
// ///// ///// ///// ///// ///// ///// ///// ///// ///// ///// ///// ///// ///// ///// /////
bool KdCollider::Intersects(const SphereInfo& targetShape, const Math::Matrix& ownerMatrix,
                            std::list<KdCollider::CollisionResult>* pResults) const
{
    ...
    for (auto& collisionShape : m_collisionShapes)
    {
        ...
        if (collisionShape.second->Intersects(targetShape.m_sphere, ownerMatrix, pTmpRes))
        {
            ...
            tmpRes.m_collidedObjName = collisionShape.first;
            tmpRes.m_type = targetShape.m_type & collisionShape.second->GetType();
...
// 第3引数に詳細結果の受け取る機能が付いている
// ///// ///// ///// ///// ///// ///// ///// ///// ///// ///// ///// ///// ///// ///// /////
bool KdCollider::Intersects(const RayInfo& targetShape, const Math::Matrix& ownerMatrix,
                            std::list<KdCollider::CollisionResult>* pResults) const
{
    // 当たり判定無効のタイプの場合は返る
    if (targetShape.m_type & m_disableType) { return false; }
    ...
    for (auto& collisionShape : m_collisionShapes)
    {
        ...
        if (collisionShape.second->Intersects(targetShape, ownerMatrix, pTmpRes))
        {
            ...
            tmpRes.m_collidedObjName = collisionShape.first;
            tmpRes.m_type = targetShape.m_type;
...
void KdCollider::SetTypeAll(UINT _type)
{
    for (auto&& shape : m_collisionShapes)
    {
        shape.second->SetType(_type);
    }
}

void KdCollider::AddTypeAll(UINT _type)
{
    for (auto&& shape : m_collisionShapes)
    {
        shape.second->AddType(_type);
    }
}

void KdCollider::RemoveTypeAll(UINT _type)
{
    for (auto&& shape : m_collisionShapes)
    {
        shape.second->RemoveType(_type);
    }
}

void KdCollider::ClearTypeAll()
{
    for (auto&& shape : m_collisionShapes)
    {
        shape.second->ClearType();
    }
}
...
// ///// ///// ///// ///// ///// ///// ///// ///// ///// ///// ///// ///// ///// ///// /////
bool KdSphereCollision::Intersects(const DirectX::BoundingSphere& target, const Math::Matrix& world,
...
// ///// ///// ///// ///// ///// ///// ///// ///// ///// ///// ///// ///// ///// ///// /////
bool KdSphereCollision::Intersects(const KdCollider::RayInfo& target, const Math::Matrix& world,
                                   KdCollider::CollisionResult* pRes)
{
    if (!m_enable) { return false; }
...
// ///// ///// ///// ///// ///// ///// ///// ///// ///// ///// ///// ///// ///// ///// /////
bool KdModelCollision::Intersects(const DirectX::BoundingSphere& target, const Math::Matrix& world,
                                  KdCollider::CollisionResult* pRes)
{
    // 当たり判定が無効 or 形状が解放済みなら判定せず返る
    if (!m_enable || !m_shape) { return false; }

    const std::vector<ModelData::Node>& origNode = m_shape->GetNodes();
    ...
    // 当たり判定ノードとのみ当たり判定
    for (auto&& colNodeIdx : m_shape->GetCollisionMeshNodeIdxLists())
    {
        const ModelData::Node& node = origNode[colNodeIdx];
        ...
        // メッシュと球形の当たり判定実行
        if (!MeshIntersect(*node.spMesh, pushedSphere,
                           /* m_shape->m_worldMatをかけることで原点位置を気にしないでよくなる */ world, pTmpResult))
        {
            continue;
        }
        ...
        // 重なった分押し戻す
        pushedSphereCenter = DirectX::XMVectorAdd(pushedSphereCenter,
                                                  DirectX::XMVectorScale(
                                                      tmpResult.m_hitDir, tmpResult.m_overlapDistance));
    ...
    if (pRes && isHit)
    {
        ...
        pRes->m_hitDir = DirectX::XMVectorSubtract(DirectX::XMLoadFloat3(&pushedSphere.Center),
...
// 単純に計算回数が多くなる可能性があるため重くなりがち
// ///// ///// ///// ///// ///// ///// ///// ///// ///// ///// ///// ///// ///// ///// /////
bool KdModelCollision::Intersects(const KdCollider::RayInfo& target, const Math::Matrix& world,
                                  KdCollider::CollisionResult* pRes)
{
    // 当たり判定が無効 or 形状が解放済みなら判定せず返る
    if (!m_enable || !m_shape) { return false; }
    ...
    for (auto&& colNodeIdx : m_shape->GetCollisionMeshNodeIdxLists())
    {
        ...
        if (!MeshIntersect(*node.spMesh, target.m_pos, target.m_dir, target.m_range,
                           world, pTmpResult))
        {
            continue;
        }
...
// 単純に計算回数が多くなる可能性があるため重くなりがち
// ///// ///// ///// ///// ///// ///// ///// ///// ///// ///// ///// ///// ///// ///// /////
bool KdPolygonCollision::Intersects(const DirectX::BoundingSphere& target, const Math::Matrix& world,
                                    KdCollider::CollisionResult* pRes)
{
    // 当たり判定が無効 or 形状が解放済みなら判定せず返る
    if (!m_enable || !m_shape) { return false; }
...
// 単純に計算回数が多くなる可能性があるため重くなりがち
// ///// ///// ///// ///// ///// ///// ///// ///// ///// ///// ///// ///// ///// ///// /////
bool KdPolygonCollision::Intersects(const KdCollider::RayInfo& target, const Math::Matrix& world,
                                    KdCollider::CollisionResult* pRes)
{
    // 当たり判定が無効 or 形状が解放済みなら判定せず返る
    if (!m_enable || !m_shape) { return false; }
