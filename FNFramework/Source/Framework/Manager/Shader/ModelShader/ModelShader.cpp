...
void ModelShader::SetMaterial(const Material& _material, const Math::Vector4& colRate)
{
...
void ModelShader::Init()
{
    ...
    Create(L"ModelShader", renderingSetting, rangeTypes);
}

bool ModelShader::Begin()
{
    Shader::Begin(
